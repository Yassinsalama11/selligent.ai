...
-- Represents the state of the database as initialized by
-- airos/backend/src/db/schema.sql
-- This migration is marked as applied on production via `prisma migrate resolve --applied`
-- DO NOT run this migration against an already-initialized database
