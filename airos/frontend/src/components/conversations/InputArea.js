        ...
        <>
          <div className="mb-3 flex items-center gap-2">
            <button
              ...
              className="rounded-[10px] border border-[var(--inbox-border)] bg-[var(--inbox-card)] px-3 py-2 text-[12px] font-semibold text-[var(--inbox-text-secondary)] transition hover:bg-[var(--inbox-elevated)]"
            >
              Attach
            </button>
            <button
            ...
            <button
              ...
              className={`rounded-xl border px-3 py-2 text-[12px] font-semibold transition ${
                showCannedPicker
                  ...
                  : 'border-[var(--inbox-border)] bg-[var(--inbox-card)] text-[var(--inbox-text-secondary)] hover:bg-[var(--inbox-elevated)]'
              }`}
            >
              Canned
            </button>
