...
const SEED_LOGS = [
  ...
  { id:'l009', ts:'2026-04-11 13:22:44', client:'AutoDeals Cairo',     level:'error',   event:'error',               channel:'wa', msg:'Webhook delivery failed — 500 Internal Server Error', payload:{ url:'https://api.chatorai.com/webhooks/whatsapp', status:500, retries:3, nextRetry:'2026-04-11 13:37:44' } },
